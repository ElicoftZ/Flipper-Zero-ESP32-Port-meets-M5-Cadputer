...
| ** M5Stack Cardputer ADV ** ⚠️ | ESP32-S3 (Xtensa LX7) | ST7789V2 240×135| 56-key keyboard (TCA8418)| — | — | RMT TX | SPI3 |

>   ⚠️ ** M5Stack Cardputer ADV  — supported but barely usable ** ESP32-S3 has only **512KB SRAM and no PSRAM**. RAM-heavy apps are effectively non-functional.
